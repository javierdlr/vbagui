...
vbagui_strings.h: vbagui.cd
#	APPDIR:CatComp vbagui.cd CFILE vbagui_strings.h
...
$(SRC_DIR)main.o: $(SRC_DIR)main.c $(SRC_DIR)includes.h $(SRC_DIR)vbagui_cat.h

$(SRC_DIR)resources.o: $(SRC_DIR)resources.c $(SRC_DIR)includes.h $(SRC_DIR)vbagui_cat.h

$(SRC_DIR)gui.o: $(SRC_DIR)gui.c $(SRC_DIR)includes.h $(SRC_DIR)vbagui_cat.h
